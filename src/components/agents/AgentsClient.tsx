...
const ORG = {
  ...
  specials: [
    ...
    { id: 'agent-builder', name: 'Agent Builder', role: 'Builds Agents', emoji: '🏗️' },
  ],
  workers: [
    { id: 'email-worker', name: 'Email', role: 'Email Management', emoji: '📧' },
    { id: 'social-worker', name: 'Social', role: 'Social Media', emoji: '📱' },
    { id: 'notion-worker', name: 'Notion', role: 'Notion Sync', emoji: '📝' },
    { id: 'file-worker', name: 'File', role: 'File Management', emoji: '🗂️' },
    { id: 'brief-worker', name: 'Brief', role: 'Daily Brief', emoji: '☀️' },
    { id: 'builder-worker', name: 'Builder', role: 'Build Tasks', emoji: '🔨' },
    ...
    { id: 'qa-worker', name: 'QA', role: 'Quality Assurance', emoji: '✅' },
    { id: 'server-worker', name: 'Server', role: 'Server Ops', emoji: '🖥️' },
    { id: 'voice-capture', name: 'Voice Capture', role: 'Voice Processing', emoji: '🎤' },
    { id: 'braindump-worker', name: 'Braindump', role: 'Memory Processing', emoji: '💡' },
    { id: 'health-worker', name: 'Health', role: 'Health Tracking', emoji: '🏃' },
    { id: 'energy-manager', name: 'Energy', role: 'Energy Management', emoji: '⚡' },
    { id: 'ccc-worker', name: 'CCC', role: 'Content Creation', emoji: '🎨' },
    { id: 'podcast-ecosystem', name: 'Pod Ecosystem', role: 'Podcast Ecosystem', emoji: '🎧' },
    { id: 'compliance-checker', name: 'Compliance', role: 'Compliance', emoji: '⚖️' },
    { id: 'credential-vault', name: 'Credentials', role: 'Credential Mgmt', emoji: '🔐' },
    { id: 'security-auditor', name: 'Security', role: 'Security Audits', emoji: '🛡️' },
  ]
}
